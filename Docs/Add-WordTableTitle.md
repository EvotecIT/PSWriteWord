...
```
Add-WordTableTitle [[-Table] <InsertBeforeOrAfter>] [[-Titles] <String[]>] [[-MaximumColumns] <Int32>]
 [[-Color] <KnownColor>] [[-FontSize] <Double>] [[-FontFamily] <String>] [[-Bold] <Boolean>]
 ...
 [[-Hidden] <Boolean>] [[-Position] <Int32>] [[-IndentationFirstLine] <Single>]
