...
Add-WordTable [[-WordDocument] <Container>] [[-Paragraph] <InsertBeforeOrAfter>]
 ...
 [[-Titles] <String[]>] [-DoNotAddTitle] [[-ColummnWidth] <Single[]>] [[-TableWidth] <Single>]
 [[-Percentage] <Boolean>] [[-Color] <Color[]>] [[-FontSize] <Double[]>] [[-FontFamily] <String[]>]
 [[-Bold] <Nullable`1[]>] [[-Italic] <Nullable`1[]>] [[-UnderlineStyle] <UnderlineStyle[]>]
